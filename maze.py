...
xlocs = {0: 50,  1: 90, 2: 160, 3: 230, 4: 300, 5: 340, 6: 380, 7: 450, 8: 520,9: 590,10: 630 }
COLUMNS = 11
...
class Maze:
    def __init__(self, game):
        ...
        self.stars0 = stars0(game=self, row_index=0, y=698)
        self.stars1 = stars1(game=self, row_index=1, y=620)
        self.stars2 = stars2(game=self, row_index=2, y=550)
        self.stars3 = stars3(game=self, row_index=3, y=480)

        self.stars4 = stars4(game=self, row_index=4, y=410)
        self.stars5 = stars5(game=self, row_index=5, y=340)
        self.stars6 = stars6(game=self, row_index=6, y=270)
        self.stars7 = stars7(game=self, row_index=7, y=190)
        self.stars8 = stars8(game=self, row_index=8, y=120)
        self.stars9 = stars9(game=self, row_index=9, y=50)
...
class GridPoint:
    image0 = pg.image.load('images/blank.png')
    ...
    imagen0 = pg.image.load('images/blank.png')
    ...
    imagep0 = pg.image.load('images/blank.png')
    ...
    imagev0 = pg.image.load('images/blank.png')
    ...
    def __init__(self, game, pt=Vector(50,704), index=0, adj_list=[]):
        self.game = game
        self.screen = game.screen
        self.pt = pt
        self.index = index
