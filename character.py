...
class Character:
    ...
    def off_screen(self): return self.rect.right ==73 or self.rect.left > self.screen_rect.width
    ...
    def choose_next(self):
        ...
        if possible_idx in grid_pt.adj_list:
            ...
            if possible_idx == 55 or possible_idx == 65:
                print("WARNING -- LEAVING GRID")
            if possible_idx == 65: possible_idx = 55
            elif possible_idx == 55: possible_idx = 65
